...
class MissionPlanningPublisher(Node):
    def __init__(self, csv_file):
        super().__init__('mission_planning_checkpoint_publisher')
        self.publisher = self.create_publisher(PoseStamped, '/planning/mission_planning/checkpoint', 10)
...
class MissionPlanningGUI(tk.Tk):
    def __init__(self, csv_file):
        ...
        self.label = tk.Label(self, text="Select an ID to publish:")
        ...
        self.comment_listbox = tk.Listbox(frame, selectmode=tk.SINGLE, height=5)
